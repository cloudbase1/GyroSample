...
public class Robot extends SampleRobot {
	...
	public Robot() {
		...
		myRobot = new RobotDrive(1,2); // Drive train 2 Talons on test board
	}
	...
	public void autonomous() {
		...
		case customAuto:
		  while (isAutonomous()) {
	        double angle = imu.getAngle(); // get current heading
	        // EAP public void drive(double outputMagnitude,double curve)
